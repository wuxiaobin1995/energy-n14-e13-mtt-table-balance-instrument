<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-21 18:03:24
 * @LastEditTime: 2023-06-21 18:04:41
 * @Description : 动态稳定测试-具体测量
-->
<template>
  <div class="dynamic-stability-measure">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      ...
      audioSrc: path.join(__static, `narrate/mandarin/Test/动态稳定测试.mp3`),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/dynamic-stability-measure'),
