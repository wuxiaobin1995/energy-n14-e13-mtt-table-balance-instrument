...
-->
<template>
  <div class="dynamic-equilibrium-measure">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      ...
      audioSrc: path.join(__static, `narrate/mandarin/Train/动态平衡训练.mp3`),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/dynamic-equilibrium-measure'),
