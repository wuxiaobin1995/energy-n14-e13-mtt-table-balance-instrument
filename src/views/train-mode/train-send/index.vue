<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-21 15:16:53
 * @LastEditTime: 2023-06-21 15:17:03
...
export default {
  ...
  methods: {
    ...
    sendData() {
      ...
      const api = `http://${mttIP}/energy_t6_m5_mtt/public/index.php/balancerTable/sendBalancerTableTrainData`
      console.log(api)
